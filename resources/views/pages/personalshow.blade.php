@extends('layouts.app', ['title' => $project->name . ' - Personal Projects'])
...
<div class="py-10 bg-center bg-no-repeat bg-cover" style="background-image: url('{{ asset($project->cover_image) }}')">
    <div class="container px-8 flex justify-center">
        <img src="/{{ $project->logo }}" alt="Logo Image for {{ $project->name }} - Owen Prosser Personal Projects" class="h-64">
    </div>
</div>
...
<div class="my-16 container px-8">
    ...
    <img src="/{{ $project->preview }}" alt="Preview Image for {{ $project->name }} - Owen Prosser Personal Projects" class="w-full mt-12">
